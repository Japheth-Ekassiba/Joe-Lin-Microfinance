...
import com.demo.bank.DemoBank.helpers.HTML;
import com.demo.bank.DemoBank.helpers.Token;
import com.demo.bank.DemoBank.mailMessenger.MailMessenger;
...
public class RegisterController {
    ...
    public ModelAndView register(@Valid @ModelAttribute("registerUser")User user,
        ...
        MailMessenger.htmlEmailMessenger("info@joe-linbank.com", email, "Verify Account", emailBody);
